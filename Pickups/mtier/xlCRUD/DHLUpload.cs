...
namespace Pickups.mtier.xlCRUD
{
    public class DHLUpload
    {
        ...
        public List<DHLUpload> getDHLRecordsFromExcel() {
            List<DHLUpload> rs = null;
                ...
                using (var c = Connectors.getXLSXConnection(this.filePath)) {
                    try
                    {
                        ...
                        using (var d = cd.ExecuteReader()) {
                            ...
                            {
                                var i = 1;
                                rs = new List<DHLUpload>();
                                while (d.Read()) {
                                    var dd = new DHLUpload { };
